...
public class InitStaticCode {
    ...
    public static void initStaticCode(Context ctx) {
	    ...
	    try {
//		    Class.forName(ServiceDiscoveryManager.class.getName(), true, appClassLoader);
...
//		    Class.forName(org.jivesoftware.smackx.commands.AdHocCommandManager.class.getName(), true, appClassLoader);
		    ...
		    Class.forName(org.jivesoftware.smack.PrivacyListManager.class.getName());
		    ...
		    Class.forName(org.jivesoftware.smackx.filetransfer.FileTransferManager.class.getName());
		    Class.forName(org.jivesoftware.smackx.LastActivityManager.class.getName());
		    Class.forName(org.jivesoftware.smack.ReconnectionManager.class.getName());
		    Class.forName(org.jivesoftware.smackx.commands.AdHocCommandManager.class.getName());
